...
@app.callback(
    [Output('fig_patrimonio_ajustado_total', 'figure'),
     Output('fig_patrimonio_ajustado_afps', 'figure'),
     Output('fig_patrimonio_inversiones_total', 'figure'),
     Output('fig_patrimonio_inter_hedge_total', 'figure'),
     Output('fig_patrimonio_inter_hedge', 'figure'),
     Output('fig_patrimonio_inversiones_nacional', 'figure'),
     Output('fig_patrimonio_inversiones_nacional_monedas', 'figure'),
     Output('fig_patrimonio_inversiones_internacional', 'figure'),
     Output('fig_patrimonio_extranjeros_total', 'figure'),
     Output('fig_patrimonio_extranjeros_fondos', 'figure'),
     Output('fig_patrimonio_forwards_n', 'figure'),
     ],
    [Input(component_id='daterange_resumen', component_property='start_date'),
     Input(component_id='daterange_resumen', component_property='end_date')]
)
